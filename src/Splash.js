                ...
                <div className='Welcome'>
                    ...
                    <div className='d-flex justify-content-center d-grid gap-4 pt-3'>
                        <a href='https://github.com/chamce' target='_blank' rel='noreferrer'>
                            <svg style={ { filter: 'invert(100%)', webkitFilter: 'invert(100%)' } } xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24">
                        ...
                        <a href='https://www.linkedin.com/in/chancellorwhitaker/' target='_blank' rel='noreferrer'>
                            <svg style={ { filter: 'invert(100%)', webkitFilter: 'invert(100%)' } } xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24">
